...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`13.31.6`**. Sideload zuletzt **`13.31.1`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
