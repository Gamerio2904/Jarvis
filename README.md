...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`13.31.0`**. Sideload zuletzt **`13.30.0`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
