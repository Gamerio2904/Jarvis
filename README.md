Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.0.6`**. Sideload-APK **`18.0.6`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.0.6`** (versionCode `180006`):  
