...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`6.90.1`**. Sideload **`6.90.1`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
...
Sideload **`Jarvis.apk` `6.90.1`** (versionCode `69001`):  
