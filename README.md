...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`13.31.3`**. Sideload zuletzt **`13.31.1`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
