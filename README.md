Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.1.2`**. Sideload-APK **`18.1.2`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.1.2`** (versionCode `180102`):  
...
Testanleitung: [`docs/TEST-18.1.2.md`](docs/TEST-18.1.2.md) · Versionen: [`docs/apk.md`](docs/apk.md)
