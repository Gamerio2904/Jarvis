...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`9.9.0`**. Sideload zuletzt **`9.9.0`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
...
Sideload **`Jarvis.apk` `9.9.0`** (versionCode `90900`):  
