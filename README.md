...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`6.93.0`**. Sideload zuletzt **`6.90.0`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
