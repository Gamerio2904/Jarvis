...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`13.31.7`**. Sideload **`13.31.6`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `13.31.6`** (versionCode `133106`):  
