Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.7.0`**. Sideload-APK **`18.4.4`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.4.4`** (versionCode `180404`):  
...
PC-Test: [`docs/TEST-PC.md`](docs/TEST-PC.md) · Gerät 18.4.4: [`docs/TEST-18.4.4.md`](docs/TEST-18.4.4.md) · Versionen: [`docs/apk.md`](docs/apk.md)
