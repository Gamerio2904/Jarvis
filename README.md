...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`9.9.1`**. Sideload zuletzt **`9.9.1`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
...
Sideload **`Jarvis.apk` `9.9.1`** (versionCode `90901`):  
