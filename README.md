Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.12.0`**. Sideload-APK **`18.12.0`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.12.0`** (versionCode `181200`):  
