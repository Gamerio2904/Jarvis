...
- **Sprint 13 (geplant, prio):** `0.5.1` Router Hotfix
- **Sprint 14 (geplant, Should):** `0.5.2` Router Polish
- **Sprint 15 (geplant):** `0.6.0` Internet-Research
- **Sprint 16 (geplant):** `0.7.0` Delight + Settings
