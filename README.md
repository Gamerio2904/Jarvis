...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`12.70.0`**. Sideload zuletzt **`12.70.0`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
