Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.9.1`**. Sideload-APK **`18.9.0`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.9.0`** (versionCode `180900`):  
