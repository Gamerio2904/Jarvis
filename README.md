...
Privater Assistant auf dem **Handy**. Live **`2.29.2`** — was geht und was nicht: [`docs/00-now.md`](docs/00-now.md).
...
Sideload **`2.29.2`** (versionCode `22902`): [`docs/apk.md`](docs/apk.md)
