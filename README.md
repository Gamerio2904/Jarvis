Privater Assistant. Läuft **auf dem Handy**. App-Code **`15.2.0`**. Sideload folgt nach Build. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
