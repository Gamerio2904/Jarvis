...
Privater Assistant. Läuft **auf dem Handy**. App-Code **`6.50.0`**. Sideload **`3.18.1`**. PC-Steuerung über die Windows-App `desktop/JarvisPC.bat` im selben WLAN — nicht über NAS/Docker.
