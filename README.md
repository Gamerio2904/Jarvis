...
Privater Assistant auf dem **Handy**. Live **`2.30.0`** — was geht und was nicht: [`docs/00-now.md`](docs/00-now.md).
...
Sideload **`2.30.0`** (versionCode `23000`): [`docs/apk.md`](docs/apk.md)
