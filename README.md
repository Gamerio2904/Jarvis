Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.9.4`**. Sideload-APK folgt **`18.9.4`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.9.3`** (versionCode `180903`):  
