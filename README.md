Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.0.5`**. Sideload-APK **`18.0.5`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.0.5`** (versionCode `180005`):  
