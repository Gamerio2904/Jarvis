Privater Assistant. Läuft **auf dem Handy**. App-Code **`18.1.1`**. Sideload-APK **`18.1.1`**. PC-Steuerung: `desktop/JarvisPC.bat` → **QR-Code öffnen**, auf dem Handy scannen.
...
Sideload **`Jarvis.apk` `18.1.1`** (versionCode `180101`):  
...
Testanleitung: [`docs/TEST-18.1.1.md`](docs/TEST-18.1.1.md) · Versionen: [`docs/apk.md`](docs/apk.md)
