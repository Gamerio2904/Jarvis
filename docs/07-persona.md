...
> **Live `1.13.2`:** System-Prompt siezt, 1–2 Sätze, trocken (`persona.ts` + `guards.ts`). „Master“/„Sir“ stehen hier historisch — **nicht** im aktuellen Prompt. Menschlicher Ton ab `1.19` ([`19-next.md`](./19-next.md)), Siezen bleibt.
