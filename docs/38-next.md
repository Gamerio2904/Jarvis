...
> **Jetzt:** Code **`9.9.2`**. Export/Import ist **CODE**. Vor Sideload/Deinstall: Einstellungen → Hausstand → Exportieren. Daten sitzen in **WebView**: `localStorage` Key `jarvis_settings_v13`, IndexedDB `jarvis-ondevice`.
