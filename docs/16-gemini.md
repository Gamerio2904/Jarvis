...
> **Jetzt (`16.1.1`):** **Groq primär** für Chat/Formulierung ([`63-next.md`](./63-next.md) **CODE** seit `15.1.0`). **Gemini Spezialist** (Vision, Deep Research/Grounding, optional TTS). Rollback: `brain_v2: false` → Gemini zuerst wie `13.44`.
