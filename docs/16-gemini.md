...
> **Jetzt:** Code **`9.9.2`**. Sideload **`9.9.2`**. Gemini mit Key ist der **normale Weg**. Groq ist Backup. Das lokale 0,5B ist **reiner letzter Fallback**, nie ChatGPT/Claude. Overlay: „Gemini zuerst“.
