...
> **Jetzt:** Code **`18.8.1`**. Sideload **`18.8.1`**, versionCode `180801`. **Hirn:** Groq primär → Gemini Spezialist → 0,5B. Nächste Schiene **`18.5` PLAN** (nicht parallel zu 18.8). Index: [`42-planned.md`](./42-planned.md). Test: [`TEST-18.8.md`](./TEST-18.8.md).
