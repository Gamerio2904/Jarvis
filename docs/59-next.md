# 59 — Jarvis 12.0 Drei Flächen, ein Hirn **CODE** `12.70.0`
...
|--------|---------|-------|-------|-------|
| **209** | `12.0.0` | Leit, Rollenmatrix, Settings-Texte, Won’t | Must | **CODE** |
| **210** | `12.10.0` | Tablet-Kommandozentrale (Lage, Verlauf, Composer) | Must | **CODE** |
| **211** | `12.20.0` | Presence-Token + QR, LAN-Guard | Must | **CODE** |
| **212** | `12.30.0` | Hirn-Gerät hostet `/v1/presence` (Verlauf + POST Zeile) | Must | **CODE** |
| **213** | `12.40.0` | PC-Viewer (Browser/BAT-Fenster) | Must | **CODE** |
| **214** | `12.50.0` | Desk-Blick-Parser (Tisch an/aus) | Should | **CODE** |
