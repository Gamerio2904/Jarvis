...
> **Jetzt:** App-Code **`18.12.0`**. Sideload **`18.12.0`**, versionCode `181200`. Kamera-Fähigkeiten S6+ [`83-next.md`](./83-next.md) §3. Lage-Icons **PLAN** [`86-next.md`](./86-next.md). Test live [`TEST-18.12.md`](./TEST-18.12.md).
...
| `18.0.1` | Lage-Tab: Kugel ohne WebView-Freeze | Patch **CODE** |
...
### `18.8` — Debug-Rollback, Termin-Erinnerungen, Debug-Download [`79-next.md`](./79-next.md) **CODE + APK** `18.8.0`
...
| `18.14.0` | Lage-Kugel: Stecknadel, Flugzeug, Satellit (kein Live) | 356–360 PLAN |
...
Die Planungszeile `18.9.5` oben bleibt Sprint 336 (API/Cache).

Nachzieher **`18.9.6`** (APK, versionCode `180906`): Jeder Katalog-Agent hat
einen Sweep-Satz und Gold. „weck mich in zehn Minuten“ trifft Erinnerung
auch ohne vorheriges Normalisieren. 18.5 bleibt PLAN.

Nachzieher **`18.9.7`** (APK, versionCode `180907`): Telefonbuch-Scan nach Ja,
...
**`18.14.0`** (PLAN): Lage-Kugel-Icons. Stecknadel, Flugzeug mit Kurs,
Sat-Körper, OpenSky ±2°, Poll ≥ 10 s, nie „Live“. Sideload bleibt
`18.12.0` bis Execute. [`86-next.md`](./86-next.md).
