...
> **Jetzt:** App-Code **`18.12.2`**. Sideload **`18.12.0`**, versionCode `181200`. Serie-Bilder, Graph-Chat, Experte [`83-next.md`](./83-next.md) §4 · [`85-next.md`](./85-next.md). Test [`TEST-18.12.md`](./TEST-18.12.md).
...
| `18.12.2` | Serie-Avatare lokal, Graph im Chat, Themen-Experte | 353–355 CODE |
...
**`18.12.2`** (App-Code, versionCode `181202`): lokale Serie-Avatare,
Graph-Antworten im Chat, ein `expert`-Agent. Sideload bleibt `18.12.0`
bis zur nächsten APK.
