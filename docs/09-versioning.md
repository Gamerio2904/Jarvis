...
> **Jetzt:** App-Code **`18.10.0`**. Sideload **`18.9.8`**, versionCode `180908`, bis APK `18.10.0` (versionCode `181000`). Schiene 301–306 (Planname **`18.5`**) landet als **`18.10.0`**, nicht als `18.5.0` (Downgrade). Test [`TEST-18.10.md`](./TEST-18.10.md).
...
| `18.10.0` | TV-Wahrheit, Groq-STT, Edge-first, Observe/Working Memory (historisch 18.5 / 301–306) | 301–306 CODE |
