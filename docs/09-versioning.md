...
> **Jetzt:** App-Code **`18.10.0`**. Sideload **`18.10.0`**, versionCode `181000`. Schiene 301–306 (Planname **`18.5`**) landet als **`18.10.0`**, nicht als `18.5.0` (Downgrade). Serie-Netz [`83-next.md`](./83-next.md). Nächste Schiene **`18.11` PLAN** [`84-next.md`](./84-next.md). Test [`TEST-18.10.md`](./TEST-18.10.md) · geplant [`TEST-18.11.md`](./TEST-18.11.md).
