...
> **Jetzt:** Code **`18.0.3`** (`frontend/src/engine/store.ts` → `APP_VERSION`). Sideload-APK **`18.0.3`**, versionCode `180003`. Screenshot-Fixes (Lidl, Schach, Tabelle, Stimme). Schach-Modus 264–267 bleibt PLAN → [`70-next.md`](./70-next.md). Test [`TEST-18.0.0.md`](./TEST-18.0.0.md).
