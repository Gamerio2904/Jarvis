...
> **Stand Code `4.53.0`:** On-Device, Weltlage, Alltagskette, Algieba, Hausstand-Export, Friday, Lage neben Chat. Sideload **`3.18.1`**. Live-Ton: **Siezen**. Offene Pläne: Körper [`40-next.md`](./40-next.md), LocateAnything [`41-next.md`](./41-next.md), Weltkugel [`43-next.md`](./43-next.md).
