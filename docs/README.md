...
**Jetzt:** Code **`18.7.0`** auf `main`. Sideload-APK **`18.4.4`**, versionCode `180404`. Nächste Schiene **`18.8` PLAN** (neben `18.5` PLAN, nicht parallel). **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.4.4.md`](./TEST-18.4.4.md). Neue APK erst mit SDK.
...
| 13 | [On-Device](./13-on-device.md) | Handy: Parser + Speicher lokal; Hirn Groq primär |
| 14 | [Qualität & TV](./14-quality-tv.md) | **`0.14.1`** — härten + Tizen live |
| 16 | [Gemini](./16-gemini.md) | Spezialist (Vision/Grounding); Chat **Groq primär** seit `15.1` |
...
| 42 | [Alles geplant](./42-planned.md) | Index Live **`18.4.4`**, App **`18.7.0`**, nächste Schiene `18.8` PLAN (neben `18.5`) |
...
| 64 | [PC-Dashboard](./64-next.md) | **CODE** `15.3.0` — Sprints 239–241; Community-Plugin bleibt PLAN |
| 65 | [Reel-UI](./65-next.md) | **CODE** `16.0.0` — Sprints 242–248 |
| 66 | [Agenten-Netzwerk Ist](./66-agents-ist.md) | **CODE** `17.0.0` — Routing, Director, Organizer-Rollen §1b |
...
| 79 | [Debug-Rollback, Termin-Erinnerungen, Debug-Download 18.8](./79-next.md) | **PLAN** — Sprints 323–328; Lauf räumt Writes, Termin fragt nach 1–n Fristen, Download am Dock |
...
| 137 | `7.0.0` | **CODE** (Hierarchical Memory Leitentscheidung, in `7.0.0`) |
...
| 153 | `9.0.0` | **CODE** (OCR) |
| 154 | `9.1.0` | **CODE** (TV Device-Registry, in `9.1.0`) |
| 155 | `9.1.0` | **CODE** (Verify Launch, in `9.1.0`) |
| 156 | `9.1.0` | **CODE** (Ehrliche Launch-Sätze) |
| 157 | `9.2.0` | **CODE** (PC Capability-Levels, in `9.2.0`) |
| 158 | `9.2.0` | **CODE** (PC Confirm hart, in `9.2.0`) |
| 159 | `9.2.0` | **CODE** (Verify PC-Aktionen) |
| 160 | `9.3.0` | **CODE** (PC WebRTC-Signaling, in `9.3.0`) |
| 161 | `9.3.0` | **CODE** (Live-Dock + Sitzung, in `9.3.0`) |
| 162 | `9.3.0` | **CODE** (Verify Live-Stream) |
| 163 | `9.9.0` | **CODE** (Regression-Katalog, in `9.9.0`) |
...
| 196 | `10.61.0` | **CODE** in `10.66.0` (Alias-Lexikon härten) |
| 197 | `10.62.0` | **CODE** in `10.66.0` (Recall leer ohne Gespräch-Echo) |
| 198 | `10.63.0` | **CODE** in `10.66.0` (memoryBlock Retrieve-Memory) |
| 199 | `10.64.0` | **CODE** in `10.66.0` (parent_key nur Reise) |
| 200 | `10.65.0` | **CODE** in `10.66.0` (Gold = Live-Pfad) |
| 201 | `10.66.0` | **CODE** (Mag-ich-Parser ohne Hirn) |
| 202 | `11.0.0` | **CODE** in `11.60.0` (Fachwissen Store) |
| 203 | `11.10.0` | **CODE** in `11.60.0` (Teach-Parser) |
| 204 | `11.20.0` | **CODE** in `11.60.0` (knowledgeBlock) |
| 205 | `11.30.0` | **CODE** in `11.60.0` (Deep Research + Offer) |
| 206 | `11.40.0` | **CODE** in `11.60.0` (Settings / Hausstand) |
| 207 | `11.50.0` | **CODE** in `11.60.0` (Gold T1–T6) |
| 208 | `11.60.0` | **CODE** (Pack-REVISE / Lab-Notiz) |
| 209 | `12.0.0` | **CODE** in `12.70.0` (Drei-Flächen Leit) |
| 210 | `12.10.0` | **CODE** in `12.70.0` (Tablet-Kommandozentrale) |
| 211 | `12.20.0` | **CODE** in `12.70.0` (Presence-Token) |
| 212 | `12.30.0` | **CODE** in `12.70.0` (`/v1/presence`) |
| 213 | `12.40.0` | **CODE** in `12.70.0` (PC-Viewer) |
| 214 | `12.50.0` | **CODE** in `12.70.0` (Desk-Blick) |
| 215 | `12.60.0` | **CODE** in `12.70.0` (Gold Flächen) |
| 216 | `12.70.0` | **CODE** (LAN-Drop / VR Parking) |
| 217 | `13.0.0` | **CODE** in `13.30.0` (Körper-Leit) |
...
| 323–328 | `18.8.0`–`18.8.5` | **PLAN** (Debug-Rollback, Termin-Fristen, Debug-Download, [`79-next.md`](./79-next.md)) |

**Aktuell:** App-Code **`18.7.0`** auf `main`. Sideload-APK **`18.4.4`**, versionCode `180404`. Sprints 315–322 **CODE**. Nächste Schiene **18.8 PLAN** (nicht parallel zu 18.5). Test: [`TEST-18.4.4.md`](./TEST-18.4.4.md). Index: [`42-planned.md`](./42-planned.md). Neue APK erst mit SDK.
