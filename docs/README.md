...
**Aktuell:** Code **`18.0.3`**. Sideload-APK `18.0.2`, versionCode `180002` — `18.0.3` ist Code, noch nicht gebaut. Screenshot-Fixes (Lidl, Schach, Tabelle, Stimme). 264–267 **PLAN**. Test: [`TEST-18.0.0.md`](./TEST-18.0.0.md). Index: [`42-planned.md`](./42-planned.md).
