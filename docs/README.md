...
| 42 | [Alles geplant](./42-planned.md) | Index Live **`18.4.4`**, App **`18.6.0`**, nächste Schiene `18.5` PLAN |
...
**Aktuell:** App-Code **`18.6.0`**. Sideload-APK **`18.4.4`**, versionCode `180404`. Sprints 307–314 **CODE**. Nächste Schiene **18.5 PLAN**. Test: [`TEST-18.4.4.md`](./TEST-18.4.4.md). Index: [`42-planned.md`](./42-planned.md).
