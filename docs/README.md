...
**Jetzt:** Code **`18.8.4`**. Sideload-APK **`18.8.4`**, versionCode `180804`. Nächste Schiene **`18.5` PLAN** (nicht parallel zu 18.8 / 18.9). **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.8.md`](./TEST-18.8.md).
...
| 42 | [Alles geplant](./42-planned.md) | Index Live **`18.8.4`**, App **`18.8.4`**, nächste Schiene `18.5` PLAN |
...
| 80 | [Recover + Hirn härten 18.9](./80-next.md) | **PLAN** — Sprints 331–337; tot → Ansage → nächste Allowlist-Methode; nicht parallel zu 18.5 |
| — | [APK](./apk.md) | Sideload `18.8.4`; Test: [`TEST-18.8.md`](./TEST-18.8.md) |
...
**Aktuell:** App-Code **`18.8.4`**. Sideload-APK **`18.8.4`**, versionCode `180804`. Sprints 323–330 **CODE + APK**. Nächste Schiene **18.5 PLAN** (nicht parallel zu 18.8 / 18.9). Test: [`TEST-18.8.md`](./TEST-18.8.md). Index: [`42-planned.md`](./42-planned.md).
