...
**Jetzt:** Code **`18.12.1`**. Sideload-APK **`18.12.0`**, versionCode `181200`. Foto-Knopf wählt Kamera oder Datei. **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.12.md`](./TEST-18.12.md).
...
| 42 | [Alles geplant](./42-planned.md) | Index Live-APK **`18.12.0`**, App-Code **`18.12.1`** |
...
**Aktuell:** App-Code **`18.12.1`**. Sideload-APK **`18.12.0`**, versionCode `181200`. Foto-Knopf wählt Kamera oder Datei. Test: [`TEST-18.12.md`](./TEST-18.12.md). Index: [`42-planned.md`](./42-planned.md).
