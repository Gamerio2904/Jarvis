...
| 16 | `0.6.1` | **PLANNED** (Research Hotfix, prio) |
| 17 | `0.6.2` | **PLANNED** (Research Polish, Should) |
| 18 | `0.7.0` | **PLANNED** (Delight + Settings) |

**Nächste Umsetzung:** Sprint 16 (Hotfix) → 17 (Should) → 18.
