...
**Jetzt:** Code **`18.8.0`**. Sideload-APK **`18.4.4`**, versionCode `180404`. Nächste Schiene **`18.5` PLAN** (nicht parallel zu 18.8). **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.4.4.md`](./TEST-18.4.4.md). Neue APK erst mit SDK.
...
| 42 | [Alles geplant](./42-planned.md) | Index Live **`18.4.4`**, App **`18.8.0`**, nächste Schiene `18.5` PLAN |
...
| 323–330 | `18.8.0`–`18.8.7` | **CODE** (Debug-Rollback, Termin-Fristen, Debug-Download, Prompt-Pakete, [`79-next.md`](./79-next.md)) |

**Aktuell:** App-Code **`18.8.0`**. Sideload-APK **`18.4.4`**, versionCode `180404`. Sprints 323–330 **CODE**. Nächste Schiene **18.5 PLAN** (nicht parallel zu 18.8). Test: [`TEST-18.4.4.md`](./TEST-18.4.4.md). Index: [`42-planned.md`](./42-planned.md). Neue APK erst mit SDK.
