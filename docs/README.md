...
| 28 | [Qualität statt Breite](./28-next.md) | **`1.33`–`1.40` CODE** — Suche bis Härten |
| — | [APK](./apk.md) | Sideload `1.40.1` |
...
**Aktuell:** Sideload `1.40.1` — [`Jarvis.apk`](./apk.md). Qualität `1.34`–`1.40` plus Patch — [`28-next.md`](./28-next.md).
