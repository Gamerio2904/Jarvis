...
**Jetzt lesen:** [`00-now.md`](./00-now.md) — Live **`2.30.0`**, was der Code tut, was geplant ist.
...
| | Version | Doc |
|--|---------|-----|
| **Live** | Sideload `2.30.0` | [`00-now.md`](./00-now.md) · [`33-next.md`](./33-next.md) |
...
Nicht mehr der Laufzeit-Stack. Nur Nachlesen.

| Nr. | Dokument | Hinweis |
|-----|----------|---------|
| 06 | [MVP-Sprint-Plan](./06-mvp-sprint-plan.md) | `0.1` / Ollama |
| 12 | [NAS & APK](./12-nas-apk.md) | Compose/Proxy superseded durch On-Device |
