...
| 33 | [3.x danach](./33-next.md) | **`3.18.0` CODE** — Härten, Tablet-Lage, Traceroute, Telefon-Haus |
| — | [APK](./apk.md) | letzter Sideload `2.2.2`; Code `3.18.0` |
...
**Aktuell:** Code **`3.18.0`**. Sideload-APK zuletzt `2.2.2` — [`Jarvis.apk`](./apk.md). Lage/Härten: [`33-next.md`](./33-next.md). Intelligenz: [`32-intelligence.md`](./32-intelligence.md). Welt: [`31-next.md`](./31-next.md). PC-App: [`../desktop/README.md`](../desktop/README.md).
