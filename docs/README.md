...
**Jetzt:** Code **`18.12.0`**. Sideload-APK **`18.10.0`**, versionCode `181000`. Kamera-Fähigkeiten S6+ sind **CODE** in 18.12.0. **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.12.md`](./TEST-18.12.md).
...
| 42 | [Alles geplant](./42-planned.md) | Index Live-APK **`18.10.0`**, App-Code **`18.12.0`** |
...
| 83 | [Lage Serie-Netz](./83-next.md) | **CODE** `18.12.0` — Knoten S01–S05, Kamera-Fähigkeiten ab Staffel 6 |
| — | [APK](./apk.md) | Sideload `18.10.0`; Test: [`TEST-18.12.md`](./TEST-18.12.md) |
...
| 347 | `18.12.0` | **CODE** (Kamera-Fähigkeiten S6+, [`83-next.md`](./83-next.md) §3) |

**Aktuell:** App-Code **`18.12.0`**. Sideload-APK **`18.10.0`**, versionCode `181000`. Sprint 347 **CODE** in `18.12.0`. Test: [`TEST-18.12.md`](./TEST-18.12.md). Index: [`42-planned.md`](./42-planned.md).
