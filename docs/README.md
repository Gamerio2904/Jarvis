...
**Jetzt:** Code **`18.14.0`**. Sideload-APK **`18.12.0`**, versionCode `181200`. Lage-Icons **CODE** `18.14.0` [`86-next.md`](./86-next.md). **Hirn:** Groq primär → Gemini Spezialist → 0,5B. **Agenten-Netzwerk:** Ist-Stand in [`66-agents-ist.md`](./66-agents-ist.md). Schach: Jarvis zieht Schwarz. Test: [`TEST-18.14.md`](./TEST-18.14.md).
...
| 42 | [Alles geplant](./42-planned.md) | Index Live-APK **`18.12.0`**, App-Code **`18.14.0`** |
...
| 86 | [Lage-Kugel Icons](./86-next.md) | **CODE** `18.14.0` — Stecknadel, Flugzeug, Satellit; Sprints 356–360 |
...
| 356–360 | `18.14.0` | **CODE** (Lage-Kugel Icons, [`86-next.md`](./86-next.md)) |

**Aktuell:** App-Code **`18.14.0`**. Sideload-APK **`18.12.0`**, versionCode `181200`. Lage-Icons **CODE** `18.14.0`. Test: [`TEST-18.14.md`](./TEST-18.14.md). Index: [`42-planned.md`](./42-planned.md).
