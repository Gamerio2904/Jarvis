...
**Jetzt:** Code **`6.51.0`**. Sideload **`3.18.1`**. CODE: Körper [`40-next.md`](./40-next.md) · LocateAnything-Parser [`41-next.md`](./41-next.md) · Kugel/Globus [`43-next.md`](./43-next.md) · Debug-Lauf [`44-next.md`](./44-next.md) · Bühne & Hirn [`45-next.md`](./45-next.md) `6.50`. Parser nach Prompt-Test [`46-next.md`](./46-next.md) `6.51`. Index: [`42-planned.md`](./42-planned.md). Nächster Sideload erst nach Hausstand-Export.
...
| 42 | [Alles geplant](./42-planned.md) | Index Code `6.51` |
...
| — | [APK](./apk.md) | Sideload `3.18.1`; Code `6.51.0`; Deinstall löscht Keys — erst Hausstand-Export |
...
**Aktuell:** Code **`6.51.0`**. Sideload `3.18.1`. Parser: [`46-next.md`](./46-next.md). LocateAnything-Sidecar nach 3060-GO. Index: [`42-planned.md`](./42-planned.md).
