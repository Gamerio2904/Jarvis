...
| 13 | [On-Device](./13-on-device.md) | `0.13.1` Handy-LLM; Steckdosen `0.14.0` |
| — | [APK](./apk.md) | Sideload |
...
| 46 | `0.14.0` | **CODE** (WLAN-Steckdosen PC/Bildschirm/LEDs) |

**Aktuell:** Sideload `0.14.0` — Modell + lokale Steckdosen.
