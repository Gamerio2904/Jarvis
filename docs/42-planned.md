...
**Live-APK:** **`18.8.1`**, versionCode `180801`. App-Code **`18.8.1`**. Vor Neuinstall Hausstand exportieren (Export ist CODE, Keys sonst weg). Test: [`TEST-18.8.md`](./TEST-18.8.md).
...
App-Code `18.8.0`. Sideload **`18.8.1`**, versionCode `180801`.
