...
**Live:** App-Code **`18.1.0`**. Sideload **`18.1.0`**, versionCode `180100`. Vor Neuinstall Hausstand exportieren (Export ist CODE, Keys sonst weg). Test: [`TEST-18.1.0.md`](./TEST-18.1.0.md).
