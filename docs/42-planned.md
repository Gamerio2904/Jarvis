# 42 — Alles geplant (Stand Code `9.0.0`)

Eine Liste, die **zum Code und zu den offenen Resten passt**.

**Live:** App-Code **`9.0.0`**. Sideload **`6.90.0`**. Vor Neuinstall Hausstand exportieren (Export ist CODE, Keys sonst weg).
...
2. **Stabilität Industry-Track** [`51-phase0-audit.md`](./51-phase0-audit.md) V1–V4 `6.91`–`6.99` / `9.0` **CODE** — vor Recall und Alltag-Execute
3. Debug-Hintergrund `5.12` — PLAN (Lauf v1 ist CODE `5.11`, Session `6.91`)
4. V5 Hierarchical Memory / Recall [`49-next.md`](./49-next.md) `7.0` **PLAN** — nach V4
...
Bereits **CODE** in `9.0.0`: V4 Datei/PDF/OCR mit Verify. V3 Action-FSM, Navi-Verify, Research-Pending hart. V2 TTS-Primary, App-Actions, Banner/Chips/Wake. V1 Overlay-FSM, Weltlage ≠ Wecker, Gemini-Retry.

---

## CODE auf diesem Stand (`9.0.0`)
