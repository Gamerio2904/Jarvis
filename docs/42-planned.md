...
**Live:** App-Code **`18.0.2`**. Sideload **`18.0.2`**, versionCode `180002`. Vor Neuinstall Hausstand exportieren (Export ist CODE, Keys sonst weg). Test: [`TEST-18.0.0.md`](./TEST-18.0.0.md).
