...
### `18.8` — Debug-Rollback, Termin-Erinnerungen, Debug-Download — *PLAN*

Sprints **323–328**. Siehe [`79-next.md`](./79-next.md). Nach dem
...
Nicht parallel zu `18.5`. Sideload bleibt `18.4.4` (versionCode `180404`)
bis zum nächsten APK-Bund. Kein Cloud-Kalender.
...
Prompts seit `1.16`: [`TEST-1.16-plus.md`](./TEST-1.16-plus.md).
...
beim Verlassen; Mic-Knopf bricht ab. Kalenderblatt ohne Autofokus.
Widerspruch nach Recherche sucht den vorherigen Satz; isoliertes „Das
...
- **Vereinsnamen in der Tabelle:** Die Kurzform kannte nur die erste Liga, alles andere wurde nach 16 Zeichen hart abgeschnitten — „SpVgg Greuther F“, „Eintracht Brauns“. 19 Zweitliga-Vereine dazu, und was danach noch zu lang ist, bricht an der Wortgrenze.
