...
### `18.12.0` — Kamera-Fähigkeiten S6+ — *CODE*
...
(Route `hud`). S01–S05 ohne Szene-Wort bleibt unberührt. Sideload bleibt
**`18.10.0`**, versionCode `181000`. Test: [`TEST-18.12.md`](./TEST-18.12.md).
