...
**Hinweis:** Ab `0.13.0` läuft Jarvis on-device auf dem Handy. NAS/Docker/PC-Ollama sind entfallen. **`0.14`:** bestehendes härten + TV live. **`0.15`:** Öffnen schneller, Chat antwortet ([`15-startup-chat.md`](./15-startup-chat.md)). TTS bleibt PO-Kommando.
