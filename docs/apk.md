...
App-Code **`12.70.0`**. Sideload-APK zuletzt **`10.60.2`**. LocateAnything-Gewichte nicht in der APK.
...
**12.70.0:** Drei Flächen (209–216). Presence :18791. Sideload bleibt `10.60.2`.
...
- versionName `10.60.2` · versionCode `106002`
