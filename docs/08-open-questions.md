...
| 2026-08-15 | Q33 | **Kein Echo Show.** Jarvis läuft nicht auf Echo Show 5 (3. Gen., Rechteck, Alexa). Das Gerät ist ein Amazon-Smart-Display (Alexa/Fire-OS bzw. Vega OS), keine allgemeine Android-APK-Laufzeit. Sideload der Capacitor-App ist offiziell nicht vorgesehen; 3. Gen. (MT8169B, 5,5″ 960×480) ist geschlossen. Das ~470-MB-On-Device-Modell passt dort weder vom OS noch von RAM/Speicher. Dinge auf dem Amazon-Bildschirm anzeigen ginge nur über einen Cloud-Alexa-Skill (APL) — nicht lokal, nicht Jarvis-UI. **Werksreset, Aufschrauben, Knacken oder Code-Upload sind kein unterstützter Weg** und werden nicht dokumentiert: Reset setzt nur Alexa zurück. Bleibt Parking mit Q32/`S7.8`. | PO-Frage + Agent |
| 2026-08-15 | Q34 | **Alexa-artig ohne Amazon.** PO will kein bloßes Handy-Tippen, sondern eine Station: Bildschirm + später Stimme. Weg: (1) **Jetzt** — Android-Tablet oder altes Android-Handy, immer an, gleiche Sideload-APK, Chat auf dem Display. (2) **Stimme raus** — TTS, schon Epic E6, nur nach PO-Go. (3) **Stimme rein** — STT + Weckwort („Jarvis“), eigener Schnitt nach TTS, noch nicht geplant. Nicht: Echo Show, Google Nest, Fire-Tablet, Cloud-Skill. Denken bleibt on-device. | PO-Frage + Agent |
