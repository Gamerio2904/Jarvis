...
1. Sideload `1.41.0`. `Fahr mich zu einer Tanke` — nächste und günstigste E10 — [`28-next.md`](./28-next.md).
2. Qualität `1.34`–`1.40` plus Tanke ist CODE. Weiteres nur auf PO-Kommando.
