...
1. Sideload `1.45.0`. `nächste Apotheke`, `Hat die Apotheke auf` — [`28-next.md`](./28-next.md).
2. Qualität `1.34`–`1.44` plus Öffnungszeiten ist CODE. Weiteres nur auf PO-Kommando.
