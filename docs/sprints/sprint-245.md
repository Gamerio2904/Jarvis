...
|----|------|-------|--------|
| S245-1 | Monats-Swipe (pointer/touch auf Grid) | `Calendar.tsx` | PLAN |
| S245-2 | FAB „＋ Termin“ fix unten rechts über Nav | `Calendar.tsx`, `index.css` | PLAN |
| S245-3 | Tages-Sheet: Titel, Uhrzeit, Speichern | `Calendar.tsx` | PLAN |
| S245-4 | Sticky Wochenleiste; heute = Ring | `index.css` `.cal-*` | PLAN |
| S245-5 | Termin-Dot + Titel-Vorschau in Zelle | `Calendar.tsx` | PLAN |
| S245-6 | Sprache: `calendar-parse.ts` + Bestätigungs-Chip | `calendar-parse.ts`, Chat | PLAN |
| S245-7 | Haptic auf Native (Capacitor) bei Speichern | optional | PLAN |
| S245-8 | Jahr-Heatmap | `Calendar.tsx` | PLAN |
