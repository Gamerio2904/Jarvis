...
**Aktuell:** Code **`18.0.3`**. Sideload `18.0.3`, versionCode `180003`. Execute 227–259 **CODE**. Kugel 268–269 **CODE** in `18.0.0`. Screenshot-Fixes in `18.0.3`. 264–267 (Schach-Modus) **PLAN**. 270 nicht gezogen.
