...
**Aktuell:** Code **`18.0.2`**. Sideload `18.0.2`, versionCode `180002`. Execute 227–259 **CODE**. Kugel 268–269 **CODE** in `18.0.0`. Lage Vollbild, Küste, Agenten-Netz in `18.0.2`. 260–267 (Schach/Blöcke) **PLAN**. 270 nicht gezogen.
