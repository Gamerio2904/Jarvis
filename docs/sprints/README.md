...
**Aktuell:** Code **`18.0.4`**. Sideload-APK `18.0.4`, versionCode `180004`. Execute 227–259 **CODE**. Kugel 268–269 **CODE** in `18.0.0`. Screenshot-Fixes 260–262 **CODE** in `18.0.3`. Schach-Overlay (Koordinaten, Klick-Züge) **CODE** in `18.0.4`. 270 nicht gezogen.
