...
**Aktuell:** Code **`18.0.1`**. Sideload `18.0.1`, versionCode `180001`. Execute 227–259 **CODE**. Kugel 268–269 **CODE** in `18.0.0`. Lage-Tab Freeze-Fix in `18.0.1`. 260–267 (Schach/Blöcke) **PLAN**. 270 nicht gezogen.
