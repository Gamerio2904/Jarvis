...
**Aktuell:** Code **`18.0.3`**. Sideload-APK `18.0.3`, versionCode `180003`. Execute 227–259 **CODE**. Kugel 268–269 **CODE** in `18.0.0`. Screenshot-Fixes 260–262 **CODE** in `18.0.3`, zwei Tasks aus 260 offen. 263–267 (Bild-Block, Schach-Modus) **PLAN**. 270 nicht gezogen. Code-Audit vom 15.9.2026 mit Sprints **272–282** → [`../71-audit.md`](../71-audit.md); **272 zuerst und allein** — die 11 Java-Änderungen aus dem Audit sind auf einem Gerät zu prüfen.
