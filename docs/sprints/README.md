...
| 347 | [`sprint-347.md`](./sprint-347.md) | `18.12.0` | Kamera-Fähigkeiten S6+ ins Serie-Dossier | **CODE** Must |

**Aktuell:** App-Code **`18.12.0`**. Sideload-APK **`18.10.0`**, versionCode `181000`. Sprint **347 CODE** in `18.12.0`. 282 Freeze (Schema).
