...
Feature. Sideload erst nach Execute + SDK, nicht in diesem PLAN
versprechen.
...
| S328-4 | Copy | CHANGELOG 79 | Rollback ≠ Hausstand-Wipe. Download am Dock. Sideload bleibt `18.4.4` |
| S328-5 | PO | | `TEST-18.8.md` erst mit CODE+APK, nicht in diesem PLAN |
