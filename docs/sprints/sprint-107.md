# Sprint 107 — Alltag & Welt, Kickoff (`2.3.0` zuerst) **PLAN**

| Feld | Wert |
|------|------|
| Status | **PLAN** |
| Priorität | **MUST** (Reihenfolge fest, Bau auf PO-Kommando) |
| Ziel-Version | **`2.3.0`** als erste Lieferung der Welt-Reihe |
| Quelle | PO: Reihe Unwetter bis Schach planen |
| Voraussetzung | `2.2.3` (Live-Qualität). `2.2.4` optional, kein Tor. |
