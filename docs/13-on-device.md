...
> **Jetzt:** Code **`13.31.0`**. Sideload **`13.30.0`**. Die App **ist** Jarvis. **Hirn:** Gemini (Key) Hauptweg → Groq Backup → 0,5B letzter Fallback. Parser und Speicher on-device. Drei Flächen [`59-next.md`](./59-next.md) **CODE**. Debug-FGS **CODE**.
