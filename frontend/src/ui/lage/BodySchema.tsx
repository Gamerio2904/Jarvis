...
import { organLabel, type BodyOrgan } from '../../engine/hud-parse.ts'
import type { BodySnap } from '../../engine/body-snap.ts'
import { isDocumentHidden, MOTION_FRAME_MS, onVisibility, onVoiceAmp } from '../../engine/motion.ts'
