...
export const HELP_TEXT =
  'Jarvis auf diesem Handy, Version 2.1.1. Smalltalk, merken/vergessen (Widerspruch gilt auch im Plaudern), Einkaufsliste, Todos, Notizen, Erinnerungen mit Zeit — ohne Zeit fragt Jarvis wann. Wecker, Timer (spricht), lokaler Kalender, Losgehen, Fahrmodus intern nicht Apple: Straße aus dem Router, Overlay ist die Karte außer bei Spotify. Lautstärke am Steuer ist Spotify, am Fernseher nur mit „Fernseher“. Stopp trifft das letzte Medium, nicht alles. Standort, Akku, Taschenlampe. WLAN-Steckdosen lokal (Shelly, Tasmota, Tuya-LAN, Broadlink), ohne Tuya-Cloud. Anruf und SMS nach Nachfrage. Bahn nur wenn Sie Bahn sagen. Wetter nur Open-Meteo, Luft und Sonne nur auf Nachfrage. Nachrichten Tagesschau, sonst Netz, nichts erfinden. Feiertage DE. Gespräch suchen und in der Liste löschen. Filme: IMDb über OMDb, wo gratis JustWatch; Spiel … Film öffnet den Fernseher. PC: JarvisPC.bat, Bild echt, Klick nur wenn eindeutig. Foto nur mit Gemini. Wake-Word „Jarvis“. Widget: Fläche hören, Mikrofon schaltet Wake an/aus. Fernseher Tizen plus Fire TV. Ventilator über Brücke oder ehrlich fehlt. Optional Gemini. Rabatt-Suche unter Netz zuschaltbar. Kein Apple CarPlay, kein WhatsApp, kein Play Store.'
