...
export const HELP_TEXT =
  'Jarvis auf diesem Handy, Version 2.28.1. Smalltalk, merken/vergessen (Widerspruch gilt auch im Plaudern), Einkaufsliste, Todos, Notizen, Erinnerungen mit Zeit — ohne Zeit fragt Jarvis wann. Wecker, Timer (spricht), lokaler Kalender, Losgehen, Fahrmodus intern nicht Apple: Straße aus dem Router, Overlay ist die Karte außer bei Spotify. Tablet-Modus: „aktiviere fullscreen“ füllt den Schirm, hört auf Jarvis und zeigt Wetter, Status und das letzte Foto. Unwetter nur DWD, Schulferien, EZB-Kurs, Open Food Facts, Open Library, Bundesliga über OpenLigaDB, ISS und Mond, Flüge über OpenSky, Alltag-Paragraph mit Link, Waschzeichen, Schritte und Luftdruck lokal, Schach im Chat. Blitzer und Baustellen aus OSM und Autobahn GmbH — mobile Blitzer kein Amt. Amazon Musik öffnet die App, spielt nicht intern. Chats in Ordner. Instanudeln-Angebot nur mit belegter Suche. FC 26: Foto, Karrierejahr, drei Vorschläge, Karten im Tablet. Lautstärke am Steuer ist Spotify, am Fernseher nur mit „Fernseher“. Stopp trifft das letzte Medium, nicht alles. Standort, Uhrzeit, Akku, Taschenlampe. WLAN-Steckdosen lokal (Shelly, Tasmota, Tuya-LAN, Broadlink), ohne Tuya-Cloud. Anruf und SMS nach Nachfrage. Bahn nur wenn Sie Bahn sagen. Wetter nur Open-Meteo, Luft und Sonne nur auf Nachfrage. Nachrichten Tagesschau, sonst Netz, nichts erfinden. Mit Gemini sucht Jarvis von selbst, wenn Zahlen fehlen — Wikipedia und Destatis zuerst. Feiertage DE. Gespräch suchen und in der Liste löschen. Filme: IMDb über OMDb, wo gratis JustWatch; Spiel … Film öffnet den Fernseher. PC: JarvisPC.bat, Bild echt, Klick nur wenn eindeutig. Foto nur mit Gemini. Wake-Word „Jarvis“. Widget: Fläche hören, Mikrofon schaltet Wake an/aus. Fernseher Tizen plus Fire TV. Ventilator über Brücke oder ehrlich fehlt. Optional Gemini. Rabatt-Suche unter Netz zuschaltbar. Kein Apple CarPlay, kein WhatsApp, kein Play Store, kein Anwalts-Rat, keine Essbarkeit.'
