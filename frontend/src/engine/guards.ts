...
export const HELP_TEXT =
  'Jarvis auf diesem Handy. Smalltalk, merken/vergessen, Todos (mit Ja/Nein), Notiz: speichert direkt. Fernseher nach dem Koppeln. Optional Gemini; Internet-Research extra in den Einstellungen — sonst keine Live-Suche.'
