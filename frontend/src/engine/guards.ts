...
export const HELP_TEXT =
  'Jarvis auf diesem Handy, Version 2.30.0. Smalltalk, merken/vergessen (Widerspruch gilt auch im Plaudern), Einkaufsliste getrennt vom Kaufmodus. Todos, Notizen, Erinnerungen mit Zeit — ohne Zeit fragt Jarvis wann. Wecker, Timer (spricht), lokaler Kalender, Losgehen, Fahrmodus intern nicht Apple: Straße aus dem Router, Overlay ist die Karte außer bei Spotify. Lautstärke am Steuer ist Spotify, am Fernseher nur mit „Fernseher“. Stopp trifft das letzte Medium, nicht alles. Nochmal wiederholt den letzten Befehl. Standort, Uhrzeit, Akku, Taschenlampe, Schritte und Luftdruck wenn der Sensor sie liefert. WLAN-Steckdosen lokal (Shelly, Tasmota, Tuya-LAN, Broadlink), ohne Tuya-Cloud. Anruf und SMS nach Nachfrage. Bahn nur wenn Sie Bahn sagen. Wetter Open-Meteo, Unwetter nur DWD/Bright Sky. Luft und Sonne nur auf Nachfrage. Nachrichten Tagesschau, sonst Netz, nichts erfinden. Ferien, EZB-Kurs, Bundesliga, ISS, Open Food Facts, Open Library, Schach e2e4. Mit Gemini sucht Jarvis von selbst, wenn Zahlen fehlen. Feiertage DE. Gespräch suchen und in der Liste löschen. Filme: IMDb über OMDb, wo gratis JustWatch; Spiel … Film öffnet den Fernseher. PC: JarvisPC.bat, Bild echt, Klick nur wenn eindeutig. Foto nur mit Gemini. Wake-Word „Jarvis“. Widget: Fläche hören, Mikrofon schaltet Wake an/aus. Einstellungen als Datei sichern. Fernseher Tizen plus Fire TV, koppeln per Stimme. Ventilator über Brücke oder ehrlich fehlt. Optional Gemini. Rabatt-Suche unter Netz zuschaltbar. Kaufmodus: Such mir …, Vergleich, Zum Händler — keine Bestellung, keine Einkaufsliste. Kein Apple CarPlay, kein WhatsApp, kein Play Store.'
