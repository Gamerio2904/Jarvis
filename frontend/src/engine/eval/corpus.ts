...
export const GOLD_EXPECT: Record<string, string> = {
  ...
  'Öffne das watchlist overlay': 'watchlist',
  'WHOIS example.com': 'osint',
  'Zeig Kameras': 'wont',
  ...
  'Öffne CarPlay': 'drive',
  // 18.0.3 Screenshot-Bugs + Tiefenprüfung (gleiche Texte wie TEST_PROMPTS).
  'Lidl': 'poi',
  'nächster Lidl': 'poi',
  'Fahr zum Lidl': 'poi',
  'Aldi': 'poi',
  ...
  'Netto': 'poi',
  'Edeka': 'poi',
  'nächster Lidl bitte': 'poi',
  'zum Lidl': 'poi',
  'Lidl in der Nähe': 'poi',
  'nächster Rewe': 'poi',
  'nächster Penny': 'poi',
  'Kaufland': 'poi',
  'nächster Kaufland': 'poi',
  'dm': 'poi',
  'nächster dm': 'poi',
  'Rossmann': 'poi',
  'nächster Aldi Süd': 'poi',
  'nächste Apotheke bitte': 'poi',
  'Lass uns Schach spielen': 'chess',
  'Schach': 'chess',
  'Zeig mir das Schachbrett': 'chess',
  'das Schachbrett': 'chess',
  'Bauer e2 e4': 'chess',
  'Dame e2 e4': 'chess',
  'Läufer e8 f9': 'chess',
  'Springer g1 f3': 'chess',
  'Turm a1 a8': 'chess',
  'König e1 e2': 'chess',
  'e2 e4': 'chess',
  'E2 e4': 'chess',
  ...
  'Wie steht die 2. Bundesliga?': 'sport',
  'Wie steht die zweite Bundesliga?': 'sport',
  'Wie steht die 2. Liga?': 'sport',
  'Wie hat der VfB gespielt?': 'sport',
  'Bundesliga Tabelle': 'sport',
  'Zeig die Bundesliga Tabelle': 'sport',
  'Was kostet E10 an der nächsten Tankstelle': 'fuel',
  ...
  'Nicht stören': 'device',
  'Spotify Pause': 'drive',
  'Spotify weiter': 'drive',
  'Lautstärke leiser': 'tv',
  'Nachrichten heute': 'news',
  'Was steht in den Nachrichten': 'news',
  'Unwetterwarnung': 'warn',
  'Zeig Erdbeben': 'hud',
  'Zeig Waldbrände': 'hud',
  'Wo brennt es': 'hud',
  'ISS über uns': 'sky',
  'Mondphase': 'sky',
  'Was fliegt da': 'flights',
  'Blitzer auf der Strecke': 'blitzer',
  'Baustelle': 'blitzer',
  'Kalender heute': 'calendar',
  'Termin absagen': 'calendar',
  'weck mich in zehn Minuten': 'reminder',
  'Ventilator aus': 'fan',
  'PC testen': 'pc',
  'PC koppeln': 'pc',
  'TV aus': 'tv',
  'YouTube am Fernseher': 'tv',
  'Amazon Prime am Fernseher': 'tv',
  'Körper aus': 'hud',
  'Kugel aus': 'hud',
  'Wo liegt Paris': 'hud',
  'Wo liegt Tokio': 'hud',
  'Wer bin ich': 'memory',
  'Was mag ich': 'memory',
  'vergiss meinen Namen': 'memory',
  'Einkaufsliste': 'shopping',
  'Butter auf die Liste': 'shopping',
  'Eier kaufen': 'shopping',
  'Mit der Bahn nach Stuttgart': 'transit',
  'Zug nach München': 'transit',
  'bestell ein Uber': 'taxi',
  'Rufe Mama an': 'maps',
  'SMS an Papa ich komm später': 'maps',
  'Freundin anrufen': 'maps',
  'Nach Hause': 'drive',
  'Fahr nach Hause': 'drive',
  'Wie lange noch': 'drive',
  'Wahlergebnis': 'research',
  'Wer hat die Wahl gewonnen?': 'research',
  'Wecker aus': 'alarm',
  'Timer stopp': 'timer',
  'Stopp Timer': 'timer',
...
export const REGRESS_EXPECT: Record<string, string> = {
  ...
  'Was fliegt über uns': 'flights',
  'Was ist über uns': 'flights',
  'Zeig Erdbeben': 'hud',
  'Wo brennt es': 'hud',
  'Zeig Waldbrände': 'hud',
  'Wie steht die Bundesliga?': 'sport',
