/** Prompt-Katalog: Einstellungen → Tests, Debug spielt sie ab. Auch für npm run test:prompts. */
...
export const TEST_COPY_GROUPS: TestCopyGroup[] = [
  ...
  },
  {
    id: 'world',
    title: 'Welt',
    hint: 'Unwetter, Schach',
    items: [
      { label: 'Unwetter', text: 'Gibt’s Unwetter?' },
      { label: 'Unwetter klar', text: 'Gibt es Unwetter?' },
      { label: 'DWD', text: 'DWD Warnung' },
      { label: 'Wetterwarnung', text: 'Wetterwarnung' },
      { label: 'Ferien BW', text: 'Sind in BW Ferien?' },
      { label: 'Schulferien Bayern', text: 'Schulferien in Bayern' },
      { label: 'Ferien Hessen', text: 'Ferien in Hessen' },
      { label: 'Dollar', text: 'Was ist der Dollar?' },
      { label: 'Euro in Dollar', text: 'Euro in Dollar' },
      { label: 'Wechselkurs', text: 'Wechselkurs' },
      { label: 'Kurs Dollar', text: 'Kurs von Dollar' },
      { label: 'Produkt', text: 'Was ist das für ein Produkt?' },
      { label: 'Nutri-Score', text: 'Nutri-Score' },
      { label: 'Barcode', text: 'Barcode' },
      { label: 'Buch', text: 'Was ist das für ein Buch?' },
      { label: 'Wer schrieb', text: 'Wer schrieb Faust' },
      { label: 'Bundesliga VfB', text: 'Wie hat der VfB gespielt?' },
      { label: 'Ergebnis Bayern', text: 'Ergebnis Bayern' },
      { label: 'Ergebnis Dortmund', text: 'Ergebnis Dortmund' },
      { label: 'Bundesliga', text: 'Bundesliga' },
      { label: 'Pflanze', text: 'Was ist das für eine Pflanze?' },
      { label: 'Kraut', text: 'Welches Kraut ist das?' },
      { label: 'Mondphase', text: 'Mondphase' },
      { label: 'ISS', text: 'Wann fliegt die ISS?' },
      { label: 'ISS lang', text: 'Internationale Raumstation' },
      { label: 'Vogel', text: 'Welcher Vogel ist das?' },
      { label: 'Tier', text: 'Was für ein Tier ist das?' },
      { label: 'iNaturalist', text: 'iNaturalist' },
      { label: 'Flug', text: 'Was fliegt da?' },
      { label: 'Flugzeug', text: 'Flugzeug über uns' },
      { label: 'OpenSky', text: 'OpenSky' },
      { label: 'Kündigung', text: 'Kündigungsfrist Wohnung' },
      { label: 'Mietrecht', text: 'Mietrecht' },
      { label: 'Waschschüssel', text: 'Was bedeutet die Waschschüssel?' },
      { label: 'Waschsymbol', text: 'Waschsymbol' },
      { label: 'Bügelsymbol', text: 'Bügelsymbol' },
      { label: 'Fleck', text: 'Fleck auf dem Hemd' },
      { label: 'Schritte', text: 'Wie viele Schritte heute?' },
      { label: 'Luftdruck', text: 'Luftdruck' },
      { label: 'Barometer', text: 'Barometer' },
      { label: 'Kompass', text: 'Kompass' },
      { label: 'Nordrichtung', text: 'Nordrichtung' },
      { label: 'Schach Zug', text: 'Schach e2e4' },
      { label: 'Schach neu', text: 'Schach neu' },
      { label: 'Schach reset', text: 'Schach reset' },
      { label: 'Schach Stellung', text: 'Schach Stellung' },
      { label: 'Schach', text: 'Schach' },
    ],
  },
  {
    id: 'edge',
