...
export const TEST_COPY_GROUPS: TestCopyGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Bist du ChatGPT', text: 'Bist du ChatGPT?', expect: { tool: 'smalltalk' } },
      { label: 'Bist du eine KI', text: 'Bist du eine KI?', expect: { tool: 'smalltalk' } },
      { label: 'Bilder malen', text: 'Kannst du Bilder malen?', expect: { tool: 'refuse' } },
      { label: 'Witz', text: 'Erzähl einen Witz', expect: { tool: 'smalltalk' } },
      { label: '2 plus 2', text: 'Was ist 2 plus 2?', expect: { tool: 'smalltalk' } },
      { label: 'Instagram', text: 'Öffne Instagram', expect: { tool: 'refuse' } },
      { label: 'Pizza', text: 'Bestell Pizza', expect: { tool: 'refuse' } },
      { label: 'Notruf 112', text: 'Rufe 112', expect: { tool: 'refuse' } },
      ...
      { label: 'Wie heißt du', text: 'Wie heißt du?', expect: { tool: 'smalltalk' } },
      { label: 'Foto machen', text: 'Mach ein Foto', expect: { tool: 'refuse' } },
      ...
      { label: 'E-Mail', text: 'Schreib mir eine E-Mail', expect: { tool: 'refuse' } },
    ],
  },
  {
    title: 'Kaputt 6.50',
    items: [
      { label: 'Zeig mir ohne Ort', text: 'Zeig mir', expect: { tool: 'refuse' } },
      ...
      { label: 'Street View', text: 'Zeig Street View von London', expect: { tool: 'refuse' } },
      ...
      { label: 'Live-Sat', text: 'Mach Live-Satellitenvideo an', expect: { tool: 'refuse' } },
      { label: 'Beobachten', text: 'Beobachte die Leute auf der Straße', expect: { tool: 'refuse' } },
