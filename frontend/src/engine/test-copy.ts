...
export const TEST_COPY_GROUPS: TestCopyGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Käse drauf", text: "Käse auf die Liste", expect: {"tool":"shopping"} },
    ],
  },
  {
    title: "Tag & Hilfe",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Timer Tee", text: "Timer 1 Minute Tee", expect: {"tool":"timer"} },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Fristen 24h und 2h", text: "24 Stunden davor und 2 Stunden davor" },
      { label: "Eine Stunde davor", text: "eine Stunde davor" },
      { label: "15 Minuten davor", text: "15 Minuten davor" },
      { label: "Am Termin", text: "am Termin" },
      { label: "Keine Erinnerung", text: "keine Erinnerung" },
      { label: "Termin Freitag Meeting", text: "Termin Freitag 10 Uhr Teammeeting", expect: {"tool":"calendar"} },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "PC QR", text: "PC QR scannen", expect: {"tool":"pc"} },
  ...
  },
  {
    title: "Fachwissen-11",
    items: [
      { label: "T1 Antriebsquelle lehren", text: "Lern das als Fachwissen Antriebsquelle: Palladium ist knapp, Integration ist das Engpass.", expect: {"tool":"teach"} },
      { label: "T2 Bei uns fragen", text: "Was steht bei uns zur Antriebsquelle?", expect: {"tool":"pack"} },
      { label: "T3 Mate nicht Pack", text: "Was trinke ich?", expect: {"tool":"memory"} },
      { label: "T4 Steuer lehren", text: "Lern das als Fachwissen Steuer 2026: Der Grundfreibetrag steigt 2026.", expect: {"tool":"teach"} },
      { label: "T5 Vergiss Antriebsquelle", text: "Vergiss Fachwissen Antriebsquelle", expect: {"tool":"pack"} },
      { label: "T6 Deep Research", text: "Recherchiere tief: Anzugs-Energiequelle ehrlich, ohne Marvel-Magie. Entwirf Constraints und Stand der Technik." },
      { label: "Reel ohne Magie", text: "Recherchiere tief und entwirf eine ehrliche Anzugs-Energiequelle. Keine Marvel-Magie, nur belegte Constraints." },
      { label: "Deep Researche Stalingrad", text: "Deep Researche was im 2 Weltkrieg in Stalingrad passiert ist für meine Abi Prüfung" },
      { label: "Alltagsfach FritzBox", text: "Lern das als Fachwissen FritzBox-Doku: Das WLAN-Passwort steht unter dem Router, nicht im Chat.", expect: {"tool":"teach"} },
      { label: "Lichtbogen", text: "Lern das als Fachwissen Lichtbogen: Palladium ist knapp.", expect: {"tool":"teach"} },
    ],
  },
  {
    title: "Körper-13",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Schach spielen", text: "Lass uns Schach spielen", expect: {"tool":"chess"} },
      ...
      { label: "Koch aus Foto", text: "Was kann ich aus dem Foto kochen", expect: {"tool":"cook"} },
      { label: "Gewürze merken", text: "Merke dir meine Gewürze", expect: {"tool":"cook"} },
      { label: "Gewürze zeigen", text: "Welche Gewürze habe ich?", expect: {"tool":"cook"} },
      { label: "Carbonara suchen", text: "Suche im Internet nach Carbonara-Rezept", expect: {"tool":"research"} },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Lidl", text: "Lidl", expect: {"tool":"poi"} },
      { label: "nächster Lidl", text: "nächster Lidl", expect: {"tool":"poi"} },
      { label: "Fahr zum Lidl", text: "Fahr zum Lidl", expect: {"tool":"poi"} },
      { label: "Aldi", text: "Aldi", expect: {"tool":"poi"} },
      { label: "nächster Aldi", text: "nächster Aldi", expect: {"tool":"poi"} },
      { label: "Rewe", text: "Rewe", expect: {"tool":"poi"} },
      { label: "Penny", text: "Penny", expect: {"tool":"poi"} },
      { label: "Netto", text: "Netto", expect: {"tool":"poi"} },
      { label: "Edeka", text: "Edeka", expect: {"tool":"poi"} },
      { label: "nächster Lidl bitte", text: "nächster Lidl bitte", expect: {"tool":"poi"} },
      { label: "zum Lidl", text: "zum Lidl", expect: {"tool":"poi"} },
      { label: "Lidl in der Nähe", text: "Lidl in der Nähe", expect: {"tool":"poi"} },
      { label: "nächster Rewe", text: "nächster Rewe", expect: {"tool":"poi"} },
      { label: "nächster Penny", text: "nächster Penny", expect: {"tool":"poi"} },
      { label: "Kaufland", text: "Kaufland", expect: {"tool":"poi"} },
      { label: "nächster Kaufland", text: "nächster Kaufland", expect: {"tool":"poi"} },
      { label: "dm", text: "dm", expect: {"tool":"poi"} },
      { label: "nächster dm", text: "nächster dm", expect: {"tool":"poi"} },
      { label: "Rossmann", text: "Rossmann", expect: {"tool":"poi"} },
      { label: "nächster Aldi Süd", text: "nächster Aldi Süd", expect: {"tool":"poi"} },
      { label: "nächste Apotheke bitte", text: "nächste Apotheke bitte", expect: {"tool":"poi"} },
      { label: "Schach spielen", text: "Lass uns Schach spielen", expect: {"tool":"chess"} },
      { label: "Schach", text: "Schach", expect: {"tool":"chess"} },
      { label: "Schachbrett zeigen", text: "Zeig mir das Schachbrett", expect: {"tool":"chess"} },
      { label: "das Schachbrett", text: "das Schachbrett", expect: {"tool":"chess"} },
      { label: "Bauer e2 e4", text: "Bauer e2 e4", expect: {"tool":"chess"} },
      { label: "Dame e2 e4", text: "Dame e2 e4", expect: {"tool":"chess"} },
      { label: "Läufer e8 f9", text: "Läufer e8 f9", expect: {"tool":"chess"} },
      { label: "Springer g1 f3", text: "Springer g1 f3", expect: {"tool":"chess"} },
      { label: "Turm a1 a8", text: "Turm a1 a8", expect: {"tool":"chess"} },
      { label: "König e1 e2", text: "König e1 e2", expect: {"tool":"chess"} },
      { label: "e2 e4", text: "e2 e4", expect: {"tool":"chess"} },
      { label: "E2 e4", text: "E2 e4", expect: {"tool":"chess"} },
      { label: "Spiel Schach", text: "Spiel Schach", expect: {"tool":"chess"} },
      { label: "Las uns Schach", text: "Las uns Schach spielen", expect: {"tool":"chess"} },
      { label: "wollen wir Schach", text: "wollen wir Schach spielen", expect: {"tool":"chess"} },
      { label: "Schachbrett", text: "Schachbrett", expect: {"tool":"chess"} },
      { label: "neues Schach", text: "neues Schach", expect: {"tool":"chess"} },
      { label: "Schach neu", text: "Schach neu", expect: {"tool":"chess"} },
      { label: "Bundesliga", text: "Wie steht die Bundesliga?", expect: {"tool":"sport"} },
      { label: "2. Bundesliga", text: "Wie steht die 2. Bundesliga?", expect: {"tool":"sport"} },
      { label: "zweite Bundesliga", text: "Wie steht die zweite Bundesliga?", expect: {"tool":"sport"} },
      { label: "2. Liga", text: "Wie steht die 2. Liga?", expect: {"tool":"sport"} },
      { label: "VfB gespielt", text: "Wie hat der VfB gespielt?", expect: {"tool":"sport"} },
      { label: "Bundesliga Tabelle", text: "Bundesliga Tabelle", expect: {"tool":"sport"} },
      { label: "Zeig Bundesliga-Tabelle", text: "Zeig die Bundesliga Tabelle", expect: {"tool":"sport"} },
      { label: "E10-Preis", text: "Was kostet E10 an der nächsten Tankstelle", expect: {"tool":"fuel"} },
      ...
      { label: "Taschenlampe", text: "Taschenlampe", expect: {"tool":"device"} },
      { label: "WLAN an", text: "WLAN an", expect: {"tool":"device"} },
      { label: "Bluetooth an", text: "Bluetooth an", expect: {"tool":"device"} },
      { label: "Nicht stören", text: "Nicht stören", expect: {"tool":"device"} },
      { label: "Spotify Pause", text: "Spotify Pause", expect: {"tool":"drive"} },
      { label: "Spotify weiter", text: "Spotify weiter", expect: {"tool":"drive"} },
      { label: "Lautstärke leiser", text: "Lautstärke leiser", expect: {"tool":"tv"} },
      { label: "Nachrichten heute", text: "Nachrichten heute", expect: {"tool":"news"} },
      { label: "Was steht in den Nachrichten", text: "Was steht in den Nachrichten", expect: {"tool":"news"} },
      { label: "Unwetterwarnung", text: "Unwetterwarnung", expect: {"tool":"warn"} },
      { label: "Zeig Erdbeben", text: "Zeig Erdbeben", expect: {"tool":"hud"} },
      { label: "Zeig Waldbrände", text: "Zeig Waldbrände", expect: {"tool":"hud"} },
      { label: "Zeig Flugzeuge", text: "Zeig Flugzeuge", expect: {"tool":"hud"} },
      { label: "Zeig Satelliten", text: "Zeig Satelliten", expect: {"tool":"hud"} },
      { label: "Wo brennt es", text: "Wo brennt es", expect: {"tool":"hud"} },
      { label: "ISS über uns", text: "ISS über uns", expect: {"tool":"sky"} },
      { label: "Mondphase", text: "Mondphase", expect: {"tool":"sky"} },
      { label: "Was fliegt da", text: "Was fliegt da", expect: {"tool":"flights"} },
      { label: "Blitzer auf der Strecke", text: "Blitzer auf der Strecke", expect: {"tool":"blitzer"} },
      { label: "Baustelle", text: "Baustelle", expect: {"tool":"blitzer"} },
      { label: "Kalender heute", text: "Kalender heute", expect: {"tool":"calendar"} },
      { label: "Termin absagen", text: "Termin absagen", expect: {"tool":"calendar"} },
      { label: "weck mich in zehn Minuten", text: "weck mich in zehn Minuten", expect: {"tool":"reminder"} },
      { label: "Ventilator aus", text: "Ventilator aus", expect: {"tool":"fan"} },
      { label: "PC testen", text: "PC testen", expect: {"tool":"pc"} },
      { label: "PC koppeln", text: "PC koppeln", expect: {"tool":"pc"} },
      { label: "TV aus", text: "TV aus", expect: {"tool":"tv"} },
      { label: "YouTube am Fernseher", text: "YouTube am Fernseher", expect: {"tool":"tv"} },
      { label: "Amazon Prime am Fernseher", text: "Amazon Prime am Fernseher", expect: {"tool":"tv"} },
      { label: "Körper aus", text: "Körper aus", expect: {"tool":"hud"} },
      { label: "Kugel aus", text: "Kugel aus", expect: {"tool":"hud"} },
      { label: "Wo liegt Paris", text: "Wo liegt Paris", expect: {"tool":"hud"} },
      { label: "Wo liegt Tokio", text: "Wo liegt Tokio", expect: {"tool":"hud"} },
      { label: "Wer bin ich", text: "Wer bin ich", expect: {"tool":"memory"} },
      { label: "Was mag ich", text: "Was mag ich", expect: {"tool":"memory"} },
      { label: "vergiss meinen Namen", text: "vergiss meinen Namen", expect: {"tool":"memory"} },
      { label: "Einkaufsliste", text: "Einkaufsliste", expect: {"tool":"shopping"} },
      { label: "Butter auf die Liste", text: "Butter auf die Liste", expect: {"tool":"shopping"} },
      { label: "Eier kaufen", text: "Eier kaufen", expect: {"tool":"shopping"} },
      { label: "Bahn Stuttgart", text: "Mit der Bahn nach Stuttgart", expect: {"tool":"transit"} },
      { label: "Zug nach München", text: "Zug nach München", expect: {"tool":"transit"} },
      { label: "bestell ein Uber", text: "bestell ein Uber", expect: {"tool":"taxi"} },
      { label: "Rufe Mama an", text: "Rufe Mama an", expect: {"tool":"maps"} },
      { label: "SMS an Papa", text: "SMS an Papa ich komm später", expect: {"tool":"maps"} },
      { label: "Freundin anrufen", text: "Freundin anrufen", expect: {"tool":"maps"} },
      { label: "Nach Hause", text: "Nach Hause", expect: {"tool":"drive"} },
      { label: "Fahr nach Hause", text: "Fahr nach Hause", expect: {"tool":"drive"} },
      { label: "Wie lange noch", text: "Wie lange noch", expect: {"tool":"drive"} },
      { label: "Wahlergebnis", text: "Wahlergebnis", expect: {"tool":"research"} },
      { label: "Wer hat die Wahl gewonnen", text: "Wer hat die Wahl gewonnen?", expect: {"tool":"research"} },
      { label: "Wecker aus", text: "Wecker aus", expect: {"tool":"alarm"} },
      { label: "Timer stopp", text: "Timer stopp", expect: {"tool":"timer"} },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Zeig Filme", text: "Zeig Filme", expect: {"tool":"app"} },
      { label: "Kalender zu", text: "Kalender zu", expect: {"tool":"app"} },
  ...
  {
    title: "18.8 Debug & Termin",
    items: [
      { label: "Termin anlegen", text: "Termin morgen 15 Uhr Zahnarzt", expect: {"tool":"calendar"} },
      { label: "Fristen nennen", text: "24 Stunden davor und 2 Stunden davor" },
      { label: "Am Termin erinnern", text: "am Termin" },
      { label: "Keine extra Erinnerung", text: "keine Erinnerung" },
      { label: "Timer Test", text: "Timer 8 Minuten Nudeln", expect: {"tool":"timer"} },
...
export const STORYLINE_GROUPS: TestCopyGroup[] = [
  ...
  {
    title: '🔴 18.0.3 Screenshot-Bugs der Reihe nach',
    items: [
      { label: '1 – Lidl (nicht Tschechien)', text: 'Lidl', expect: { tool: 'poi' } },
      { label: '2 – nächster Lidl', text: 'nächster Lidl', expect: { tool: 'poi' } },
      { label: '3 – Fahr zum Lidl', text: 'Fahr zum Lidl', expect: { tool: 'poi' } },
      { label: '4 – Schach statt Maps', text: 'Lass uns Schach spielen', expect: { tool: 'chess' } },
      { label: '5 – ↳ Brett', text: 'Zeig mir das Schachbrett', expect: { tool: 'chess' } },
      { label: '6 – ↳ Dame auf Bauernfeld', text: 'Dame e2 e4', expect: { tool: 'chess' } },
      { label: '7 – ↳ Bauer wirklich', text: 'Bauer e2 e4', expect: { tool: 'chess' } },
      { label: '8 – ↳ illegal f9', text: 'Läufer e8 f9', expect: { tool: 'chess' } },
      { label: '9 – Bundesliga Tabelle', text: 'Wie steht die Bundesliga?', expect: { tool: 'sport' } },
      { label: '10 – 2. Liga', text: 'Wie steht die 2. Bundesliga?', expect: { tool: 'sport' } },
      { label: '11 – E10-Preis, nicht erfunden', text: 'Was kostet E10 an der nächsten Tankstelle', expect: { tool: 'fuel' } },
      { label: '12 – Regen ab jetzt, nicht Mitternacht', text: 'Regnet es gleich?', expect: { tool: 'weather' } },
      { label: '13 – Wahl live', text: 'Wer hat die Wahl gewonnen?', expect: { tool: 'research' } },
    ],
  },
  {
    title: '🟢 18.8 Termin und Debug der Reihe nach',
    items: [
      { label: '1 – Termin', text: 'Termin morgen 15 Uhr Zahnarzt', expect: { tool: 'calendar' } },
      { label: '2 – ↳ zwei Fristen', text: '24 Stunden davor und 2 Stunden davor' },
      { label: '3 – Listen', text: 'was steht heute so an?', expect: { tool: 'calendar' } },
      { label: '4 – Folie zu', text: 'Kalender zu', expect: { tool: 'app' } },
      { label: '5 – Debug-Hinweis', text: 'Zeig Chat', expect: { tool: 'app' } },
      { label: '6 – Filme', text: 'Zeig Filme', expect: { tool: 'app' } },
      { label: '7 – Titel ändern', text: 'Änder Maxi Geburtstag in Jakob Geburtstag', expect: { tool: 'calendar' } },
...
const PROBE_SOURCES: Array<{ title: string; source: string }> = [
  ...
  { title: 'Screenshots', source: 'Screenshots' },
  { title: 'Einstellungen', source: 'Einstellungen' },
  { title: 'Dokumente', source: 'Foto Notiz Dokument' },
  { title: 'Gedächtnis', source: 'Gedächtnis' },
  { title: 'Fernseher', source: 'Fernseher & Film' },
  { title: 'PC', source: 'PC' },
  { title: 'Fachwissen', source: 'Fachwissen-11' },
  { title: 'Flächen', source: 'Flächen-12' },
  { title: 'Körper', source: 'Körper-13' },
  { title: 'Kalender', source: 'Kalender & Losgehen' },
  { title: '18.7 Fläche', source: '18.7 Fläche' },
