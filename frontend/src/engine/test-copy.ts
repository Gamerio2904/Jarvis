...
export const TEST_COPY_GROUPS: TestCopyGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Graph Rick", text: "Wer ist Rick Sanchez", expect: {"tool":"hud"} },
      { label: "Graph Schild", text: "Wann hatte Rick ein automatisches Schild", expect: {"tool":"hud"} },
      { label: "Experte Star Wars", text: "Werde ein Experte in Star Wars", expect: {"tool":"expert"} },
