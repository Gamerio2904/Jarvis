...
export const COUNTRIES: CountryFix[] = [
  ...
  { id: 'us', name: 'USA', lat: 39.83, lon: -98.58, re: /\b(usa|vereinigte[n]?\s+staaten|washington|weiße[sn]?\s+haus|weißen\s+haus|new\s*york|nyc|trump)\b/i },
  ...
  { id: 'nl', name: 'Niederlande', lat: 52.13, lon: 5.29, re: /\b(niederlande|holland|amsterdam)\b/i },
  { id: 'ba', name: 'Bosnien', lat: 43.92, lon: 17.68, re: /\b(bosnien(?:krieg(?:es)?)?|srebrenica|sarajevo)\b/i },
  { id: 'no', name: 'Norwegen', lat: 60.47, lon: 8.47, re: /\b(norwegen|oslo|könig\s+harald)\b/i },
  { id: 'np', name: 'Nepal', lat: 28.39, lon: 84.12, re: /\bnepal\b/i },
